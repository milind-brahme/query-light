...
class StmtRunScreen1(v_usr: String, v_password: String, v_jdbcstr: String, dbname: String) : javax.swing.JFrame() {
    ...
    inner class dbSession(val v_usr: String, val v_password: String, val v_jdbcstr: String, val dbname: String) : javax.swing.JInternalFrame() {
        ...
        private var trackChanges: ChangeTracker? = null
        ...
        init {
            ...
            try {
                ...
                if (this.jcon != null) trackChanges = ChangeTracker(jcon!!)
                Thread({
                    ...
                    ac?.triggerKey = KeyStroke.getKeyStroke(KeyEvent.VK_SPACE, KeyEvent.CTRL_MASK)
        ...
        fun initComponents() {
            ...
            menu_tbl_copy.icon = javax.swing.ImageIcon(javaClass.getResource("/runsql_anony/Clone-50.png")) // NOI18N
            menu_tbl_copy.text = "Copy"
            menu_tbl_copy.addActionListener { evt -> menu_tbl_copyActionPerformed(evt) }
            mnu_grid.add(menu_tbl_copy)

            menu_get_count!!.icon = javax.swing.ImageIcon(javaClass.getResource("/runsql_anony/View Details-50.png")) // NOI18N
            ...
            menu_export_ins!!.icon = javax.swing.ImageIcon(javaClass.getResource("/runsql_anony/SQL-50.png")) // NOI18N
            ...
            menu_export_csv!!.icon = javax.swing.ImageIcon(javaClass.getResource("/runsql_anony/CSV-50.png")) // NOI18N
            ...
            btn_reconnect!!.icon = javax.swing.ImageIcon(javaClass.getResource("/runsql_anony/Connected-50.png")) // NOI18N
            ...
            btn_upper!!.icon = javax.swing.ImageIcon(javaClass.getResource("/runsql_anony/Up Arrow-50.png")) // NOI18N
            ...
            btn_lower!!.icon = javax.swing.ImageIcon(javaClass.getResource("/runsql_anony/Down Arrow-50.png")) // NOI18N
            ...
            btn_commit!!.icon = javax.swing.ImageIcon(javaClass.getResource("/runsql_anony/Accept Database-50.png")) // NOI18N
            ...
            btn_rollback!!.icon = javax.swing.ImageIcon(javaClass.getResource("/runsql_anony/Delete Database-50.png")) // NOI18N
        ...
        private fun v_stmt_txtKeyPressed(evt: java.awt.event.KeyEvent) {
            ...
            } else if (evt.modifiers and KeyEvent.ALT_MASK != 0 && evt.keyCode == KeyEvent.VK_C) {
                useTabProvider = !useTabProvider
                if (useTabProvider == false) {
                    trackChanges?.trackChanges(getCurrentSql())
                    colProvider = trackChanges?.provider
                    val tmp = AutoCompletion(colProvider);
                    tmp?.install(v_stmt_txt)
                } else {
    ...
    init {
        ...
        mnupref.addActionListener(object : java.awt.event.ActionListener {
            override fun actionPerformed(evt: java.awt.event.ActionEvent) {
                ...
                val img = ImageIcon(javaClass.getResource("/runsql_anony/db1-icon.png"))
        ...
        this.iconImage = ImageIcon(javaClass.getResource("/runsql_anony/db1-icon.png")).image
